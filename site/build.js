...
const PAGES = [
  ...
  },
  {
    ...
    description: 'Обучение на права тракториста-машиниста в Перми: категории B, C, D, E, снегоход и квадроцикл, погрузчик и экскаватор. Свой автодром на ул. Космонавта Леонова, 67. Срок обучения около 1,5 месяцев.',
  ...
  },
  {
    ...
    activeKey: '',
    pageCss: ['policy.css'],
    title: 'Политика защиты и обработки персональных данных — автошкола «Авто-Класс»',
    description: 'Политика защиты и обработки персональных данных АНО ДПО «Авто-класс», разработанная во исполнение Федерального закона № 152-ФЗ «О персональных данных».',
    ogImage: '/images/logo/logo-color-2x.png',
    schema: null,
    hasForm: false,
  },
